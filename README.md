...
The following ALFWorld results compare runs with and without Thompson sampling (TS) across in-distribution and out-of-distribution evaluation splits. The main varied hyperparameters are `memory.k_retrieve` and `rl_config.topk`.
